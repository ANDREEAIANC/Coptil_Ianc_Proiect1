...
namespace Coptil_Ianc_Proiect1.Migrations
{
    ...
    [Migration("20231209151312_Migration7")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Coptil_Ianc_Proiect1.Models.Programare", b =>
                {
                    ...
                    b.HasIndex("TipServiciuId");

                    b.ToTable("Programare");
                });

            modelBuilder.Entity("Coptil_Ianc_Proiect1.Models.Recenzie", b =>
                {
                    b.Property<int>("RecenzieId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("RecenzieId"), 1L, 1);
            ...
            modelBuilder.Entity("Coptil_Ianc_Proiect1.Models.TipServiciu", b =>
                {
                    b.Property<int>("TipServiciuId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("TipServiciuId"), 1L, 1);
                    ...
                    b.HasKey("TipServiciuId");

                    b.ToTable("TipServiciu");
                });
            ...
            modelBuilder.Entity("Coptil_Ianc_Proiect1.Models.Programare", b =>
                {
                    ...
                    b.HasOne("Coptil_Ianc_Proiect1.Models.TipServiciu", "TipServiciu")
                        .WithMany()
                        .HasForeignKey("TipServiciuId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
